...
var AuthService = (function () {
    ...
    AuthService.prototype.login = function (email, password, remember) {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__po__["a" /* commonRespMap */])(this.http.post(this.loginUrl, { email: email, password: password, remember: remember }));
    };
...
var LoginZoneComponent = (function () {
    function LoginZoneComponent(auth, route, sess) {
        ...
        this.regData = { email: '', pass: '', confirmPass: '', name: '', errors: [] };
        this.loginData = { email: '', pass: '', remember: false, errors: [] };
    }
    ...
    Object.defineProperty(LoginZoneComponent.prototype, "isValid", {
        get: function () {
            if (this.regActive) {
                var d = this.regData;
    ...
    LoginZoneComponent.prototype.formSubmit = function () {
        ...
        if (this.regActive) {
            var d = this.regData;
            d.errors = [];
            this.auth.register(d.name, d.email, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_compiler_src_i18n_digest__["c" /* sha1 */])(d.pass), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_compiler_src_i18n_digest__["c" /* sha1 */])(d.confirmPass)).subscribe(function (resp) {
                _this.sess.refreshAccountInfo();
            }, function (err) {
                _this.regData.errors = err.map(function (s) {
                    return {
                        type: 'danger',
                        msg: s
                    };
            ...
            var d = this.loginData;
            d.errors = [];
            this.auth.login(d.email, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_compiler_src_i18n_digest__["c" /* sha1 */])(d.pass), d.remember).subscribe(function (resp) {
                _this.sess.refreshAccountInfo();
            }, function (err) {
                _this.loginData.errors = err.map(function (s) {
                    return {
                        type: 'danger',
                        msg: s
                    };
